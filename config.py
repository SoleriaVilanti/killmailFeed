...
config_owner = [{'corporationID': 98374928}] # Format of: 'corporationID': <id> or 'allianceID': <id> (can be multiple)
config_check = '86400' # Check for the last day
config_sleep_time = 1800 # Delay between checks
config_slack_url = 'https://hooks.slack.com/services/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' # Slack integration code
